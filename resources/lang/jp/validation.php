...
return [
    ...
    */
    ...
    'twitter_id_not_existed'        => 'このTwitterユーザーIDは存在しません',
    'tweet_hashtag_invalid_format'  => 'ハッシュタグ形式（#◯◯◯）で入力してください',
    'twitter_hashtag_is_existed'    => 'このキャンペーンタグは過去に利用した事があります',
    'tweet_length'                  => ':attributeが:max_length文字入力されました。:input_length文字以内で入力してください',
    /*
    |--------------------------------------------------------------------------
